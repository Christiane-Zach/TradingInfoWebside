...
<body bgcolor="#000000" text="#ffffff">
	...
	<div class="container">
		<div class="float-left">
			...
			<br></br>
			<form action="/${oldPairName}/${oldInterval}/zoomedtime" method="post">
		...
		<div class="float-right">
			...
			function xyDiagramm(data) {
				...
				var x = d3.time.scale()                // interpolator for X axis -- inner plot region
	...
	<div class="container">
		...
		<div class="float-right">
			<br></br>
			<p>Difference between Binance and Bitfinex</p>
		</div>
	</div>
	<div class="container">
		<div class="float-left">
		...
		<div class="float-right">
			...
			var data = [
				<c:forEach items="${bbDifferences}" var="bbDifference" varStatus="status">  
				    {x: new Date('${bbDifference.time}'),
				    y: '${bbDifference.price}'}
				    <c:if test="${!status.last}">,    
				    </c:if>  
				    </c:forEach>  
				];
